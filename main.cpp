...
bool resolve(celula tabela[][9], quadrado lista_quadrados[9], int quadrados[][9])
{
	...
	{
		alterou = false;
		// 2. ve se tem s� 1 possibilidade em cada casa/quadrado/linha/coluna
		// cada casa
		for (i = 0; i < 9; i++)
		{
			for (j = 0; j < 9; j++)
		...
		// 3.1 verificar os n�meros com 2 op��es se est�o 
		...
		// 3.2 verificar duas casas com apenas 2 op��es, se 
		// forem os mesmos n�meros, tirar as possibilidades 
		// desses 2 n�meros em outras casas do mesmo quadrado.
		for (int quad = 0; quad < 9; quad++)
		{
		...
		// 4. verificar cada linha/coluna se o n�mero
		// aparece em apenas um dos quadrados, tirar 
		// esse mesmo n�mero das outras casas que n�o 
		...
		// 5. verificar se o n�mero est� em apenas
		// um sentido (linha ou coluna). Se estiver,
		// tirar esse mesmo n�mero dos outros quadrados.
		for(int quad = 0; quad < 9; quad++)
		{
			for(k = 0; k < 9; k++)
			{
